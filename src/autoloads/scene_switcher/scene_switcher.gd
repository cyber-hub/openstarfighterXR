...
const _main_menu_file_path: String = "res://src/mainXR.tscn"
const _summary_menu_file_path: String = "res://src/menu_ui/summary_menu/summaryXR.tscn"
...
func transition_to_summary_menu() -> void:
	Input.set_mouse_mode(Input.MOUSE_MODE_CONFINED)
	_change_scene_background(_summary_menu_file_path)
